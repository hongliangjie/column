...
我目前担任总部位于纽约的电子商务网站[Etsy](https://www.etsy.com/)的**工程总监**（Director of Engineering），负责数据科学和机器学习的研发工作。Etsy是一个拥有超过4500万商品、210万活跃卖家和4000万活跃买家的国际化电子交易平台。作为一名技术管理者，我发展并且管理着一支位于纽约和旧金山有近40人的数据科学家及机器学习工程师团队。团队成员绝大多数拥有硕士以及博士文凭，来自计算机科学、运筹学、统计、经济学、物理等学术背景。作为一名技术领导者，我团队主要职责是为Etsy提供全方位的数据科学支持，包括个性化与推荐、搜索、计算广告、图像处理及深度学习和文字信息挖掘等多方面的基于机器学习的产品优化方案。
